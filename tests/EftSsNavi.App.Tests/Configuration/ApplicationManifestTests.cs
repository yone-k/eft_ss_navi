...
public sealed class ApplicationManifestTests
{
    ...
    {
        var document = XDocument.Load(FindRepositoryFile("src", "EftSsNavi.App", "app.manifest"));
    ...
    private static string FindRepositoryFile(params string[] segments)
    {
        ...
        while (directory is not null && !File.Exists(Path.Combine(directory.FullName, "EftSsNavi.slnx")))
        {
